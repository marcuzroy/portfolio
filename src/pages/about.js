            ...
            <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
              ...
              md:col-span-8">
                ...
                <p className="font-medium ">
                  Hi, I&apos;m <strong>Marc</strong>, a web and mobile application developer with a passion for creating beautiful, functional, and user-centered digital experiences. With 4 years of experience in the field. I am always looking for new and innovative ways to bring my clients&apos; visions to life.
                </p>
