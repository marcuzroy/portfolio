          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                title="SwipeRx"
                img={proj2}
                link="https://play.google.com/store/apps/details?id=com.swiperx&hl=en&gl=PH"
                github=""
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                img={proj3}
                link="https://play.google.com/store/apps/details?id=com.unilab.cbg_pharma&hl=en&gl=PH"
                github=""
              />
            </div>
            <div className="col-span-12">
