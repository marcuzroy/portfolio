    ...
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="Diploma in Web Design and Development"
            time="2022-2024"
            place="Northern Alberta Institute of Technology (NAIT), Canada"
            info=""
          />
          ...
          <Details
            ...
            time="2009-2013"
            place="University of Santo Tomas, Philippines"
            info=""
          />

          <Details
            type="Bachelor of Science in Commerce Major in Economics"
            time="2001-2005"
            place="University of Santo Tomas, Philippines"
            info=""
          />
